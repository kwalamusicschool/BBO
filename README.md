...
When generating queries in Round 3, I used a sanity check that pulled back the GP's suggestions to within a trust radius around the best point. The query generated by the sanity check was submitted correctly to the portal. However, when saving the data arrays for future rounds, the pre-sanity-check value was accidentally stored instead of the actual submitted query.

This error influenced the GP's recommendations in Rounds 4–8, and therefore the optimisation path. The final best outputs reported in this project are the highest values received from the portal, based on the data arrays which included incorrect outputs for Round 3 from Round 4 onwards. 

The notebooks have been left in their original state to preserve the record of what was submitted. The correct Round 3 data is available in the `data/` folder.

**Corrected Round 3 queries (from portal):**
| Function | Correct Round 3 Query |
|----------|----------------------|
| F1 | `0.444191-0.307902` |
| F2 | `0.636773-0.791798` |
| F3 | `0.530425-0.650526-0.216832` |
| F4 | `0.541107-0.489528-0.486479-0.505504` |
| F5 | `0.284857-0.771303-0.814135-0.816544` |
| F6 | `0.636006-0.393028-0.623020-0.696337-0.268322` |
| F7 | `0.319776-0.462008-0.413965-0.361650-0.450310-0.744674` |
| F8 | `0.140870-0.228265-0.099817-0.212563-0.669446-0.400840-0.184004-0.570658` |
