...
This error influenced the GP's recommendations in Rounds 4–8, and therefore the optimisation path. The final best outputs reported in this project are the highest values received from the portal. 

The notebooks have been left in their original state to preserve the record of what was actually submitted. The corrected Round 3 data is available in the `data/` folder for anyone who wishes to explore the corrected trajectory.
